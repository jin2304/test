...
- 웹 크롤링 방법에서는 파이썬의 Selenium 라이브러리와 ChromeDriver를 이용하여 웹 크롤링을 수행하여 '광고성 리게시글' 5346개와 '일반 리뷰 게시글' 4146개 게시글 해시태그와 게시글 텍스트 데이터를 수집하였음.
...
![image](https://github.com/user-attachments/assets/ecbeb2c5-557e-4d82-a706-d29ff6649c4e)
