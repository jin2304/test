...
- 또한, Attention 메커니즘을 통해 광고성 리뷰 게시글에서 높은 중요도를 가진 상위 30개 단어를 추출하여 분석하였다. 광고성 리뷰 게시글에서 높은 중요도를 나타내는 단어는 [ 표 5 ]에서 처럼 "협찬", "official", "광고", "이벤트", "제공" ... 등과 같은 단어들이 광고성 리뷰 게시글을 판단하는데 핵심 단어인 것으로 나타났다.
